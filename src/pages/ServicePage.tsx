...
const SERVICE_CONTENT: Record<string, ServiceContent> = {
  ...
  'corporate-wear-apparel-branding': {
    ...
    products: ['Golf shirts', 'Roundneck T-shirts', 'Branded formal shirts', 'Work suits', 'Khaki shirts', 'Safari shirts', 'Jackets & puff jackets', 'Caps & flop hats'],
  ...
  'corporate-gifts-promotional-items': {
    ...
    products: ['Key rings', 'Mugs', 'Pens', 'Bottles & drinkware', 'Flasks', 'Medals', 'Lanyards', 'Gift bags', 'Helmets'],
